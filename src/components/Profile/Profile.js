                        ...
                        <MDBCard>
                            ...
                            <div className="p-4 text-black" style={{ backgroundColor: '#f8f9fa' }}>
                                <div className="d-flex justify-content-end text-center py-1">
                                    <div>
                                        <MDBCardText className="mb-1 h5">{customer.my_realty_objectList.length}</MDBCardText>
                                        <MDBCardText className="small text-muted mb-0">My realty</MDBCardText>
                                    </div>
                                    <div className="px-3">
                                        <MDBCardText className="mb-1 h5">{customer.added_to_favorites.length}</MDBCardText>
